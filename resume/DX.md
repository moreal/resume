...
제품의 초기부터 성장 과정을 따라 다양한 역할로써 넓게 일하며 여러 경험을 하였습니다. 오픈소스 기여를 즐겨하며 이를 통해서도 다양한 경험을 쌓고 회사 업무에 활용하여 효용을 보기도 하였습니다. 타입 시스템이나 도구를 활용하여 사전에 실수를 방지할 수 있는 시스템을 갖추고자 노력하였습니다.
...
위 목표에 따라 여러가지 업무를 진행했지만 아래 세가지 프로젝트들만 기술했습니다.
